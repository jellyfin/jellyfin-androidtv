...
class CustomSeekProvider(
	...
	override fun getSeekPositions(): LongArray {
		...
		// Omit the first seek position if the difference to the beginning of the video is less than a second to avoid a sub-second seek
		if (firstSeekPosition >= 1000L) {
		...
		// Omit the last seek position if the difference to the end of the video is less than a second to avoid a sub-second seek
		if (videoEndPosition - lastSeekPosition >= 1000L) {
