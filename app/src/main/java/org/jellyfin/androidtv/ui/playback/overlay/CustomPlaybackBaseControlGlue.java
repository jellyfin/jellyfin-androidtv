 ...
 */
public abstract class CustomPlaybackBaseControlGlue<T extends PlayerAdapter> extends PlaybackGlue
    ...
    final PlayerAdapter.Callback mAdapterCallback = new PlayerAdapter
        ...
        public void onMetadataChanged(PlayerAdapter wrapper) {
            CustomPlaybackBaseControlGlue.this.onMetadataChanged();
        }
    };
     ...
     */
    public CustomPlaybackBaseControlGlue(Context context, T impl) {
        super(context);
        mPlayerAdapter = impl;
