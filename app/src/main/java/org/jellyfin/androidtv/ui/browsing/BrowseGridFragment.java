...
public class BrowseGridFragment extends GridFragment {
    ...
    private ItemRowAdapter mGridAdapter;
    ...
    private void setCardHeight(final int height) {
    ...
    private void setupRetrieveListeners() {
