...
public class BrowseRowDef {
  ...
  public BrowseRowDef(
      String header, GetItemsRequest query, int chunkSize, ChangeTriggerType[] changeTriggers) {
  ...
  public BrowseRowDef(
      ...
      boolean preferParentThumb,
      boolean staticHeight,
      ChangeTriggerType[] changeTriggers) {
    this(
        header, query, chunkSize, preferParentThumb, staticHeight, changeTriggers, QueryType.Items);
  }
  ...
  public BrowseRowDef(
      String header, GetArtistsRequest query, int chunkSize, ChangeTriggerType[] changeTriggers) {
    headerText = header;
  ...
  public BrowseRowDef(
      String header, GetLatestMediaRequest query, ChangeTriggerType[] changeTriggers) {
    headerText = header;
