...
import org.jellyfin.androidtv.ui.playback.overlay.action.SyncPlayAction;
...
public class CustomPlaybackTransportControlGlue extends PlaybackTransportControlGlue<VideoPlayerAdapter> {
    ...
    private SyncPlayAction syncPlayAction;
    ...
    private void initActions(Context context) {
        ...
        syncPlayAction = new SyncPlayAction(context, this);
        syncPlayAction.setLabels(new String[]{context.getString(R.string.lbl_syncplay)});
    ...
    void addMediaActions() {
        ...
        secondaryActionsAdapter.add(syncPlayAction);
