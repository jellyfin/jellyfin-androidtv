 ...
 */
public class CustomPlaybackTransportControlGlueHelper<T extends PlayerAdapter>
        extends CustomPlaybackBaseControlGlue<T> {
    ...
    static class UpdatePlaybackStateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_UPDATE_PLAYBACK_STATE) {
                CustomPlaybackTransportControlGlueHelper glue =
                        ((WeakReference<CustomPlaybackTransportControlGlueHelper>) msg.obj).get();
                if (glue != null) {
    ...
    final WeakReference<CustomPlaybackTransportControlGlueHelper> mGlueWeakReference =
     ...
     */
    public CustomPlaybackTransportControlGlueHelper(Context context, T impl) {
        super(context, impl);
    }
    ...
    protected PlaybackRowPresenter onCreateRowPresenter() {
        final AbstractDetailsDescriptionPresenter detailsPresenter =
                new AbstractDetailsDescriptionPresenter() {
                    ...
                    protected void onBindDescription(ViewHolder
                        ...
                        CustomPlaybackTransportControlGlueHelper glue = (CustomPlaybackTransportControlGlueHelper) obj;
        ...
        PlaybackTransportRowPresenter rowPresenter = new PlaybackTransportRowPresenter() {
            ...
            protected void onBindRowViewHolder(RowPresenter.ViewHolder vh, Object item) {
                ...
                vh.setOnKeyListener(CustomPlaybackTransportControlGlueHelper.this);
