...
import org.jellyfin.androidtv.preference.constant.ZOOM_FIT
import org.jellyfin.androidtv.preference.constant.ZOOM_AUTO_CROP
import org.jellyfin.androidtv.preference.constant.ZOOM_STRETCH
import org.jellyfin.androidtv.preference.constant.getZoomModeFromId
	...
	override fun handleClickAction(
		...
		return PopupMenu(context, view, Gravity.END).apply {
			...
			setOnMenuItemClickListener { item ->
				val zoomMode = getZoomModeFromId(item.itemId)
				playbackController.setZoom(zoomMode)
				true
			}
		}.show()
	}
